...
public class LongestSubsetWithoutRepeatingCharacters {

	public static void main(String[] args) {
		System.out.println(lengthOfLongestSubstring("asacajsbayhvwelancacndfgnfkgr"));
    ...
    private static int charEqualsToCharAtThisIndex(char c, char[] seq, int firstIndex, int lastIndex) {
